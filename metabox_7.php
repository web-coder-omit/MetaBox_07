    ...
    $mata_imges = <<<EOD
        <div class="image_parent">
            <div class="image_child_1">
                ...
                <button class="btn_class_1" id="btn_id_1_s">Uoload Image</button>
                <input type="hidden" name="input_id" id="input_id_s" value="{$save_id_s}"/>
                <input type="hidden" name="input_url" id="input_url_s" value="{$save_url_s}"/>
